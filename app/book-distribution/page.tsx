    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
          ...
          <p className="pt-4">
            <strong>Where AI fit in:</strong> AI (LLMs available in 2023) assisted in multiple ways. Beyond the core system, I used AI for researching new clients for selling books, writing price offers, and getting ready for sales meetings and calls. AI also helped me build business and sales strategy — thinking through what customers I should target, what size orders to pursue, where to find them, how to approach them, and what to offer each segment. AI also analyzed data patterns from shipments and sales to help me make data-based decisions on inventory allocation and sales priorities. For the system itself, AI designed the inventory table logic and structure, mapped the inventory management workflow, and drafted billing emails. Given the tools available at the time, AI's role was limited to brainstorming, text-output, and analysis tasks — it couldn't touch the system execution itself.
          </p>
        </div>
      </section>
